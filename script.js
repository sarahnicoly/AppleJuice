...
const products = [
    // Gaming
    { id: 1, name: 'Placa de Vídeo RTX 4080 Gaming Elite', description: 'GPU de última geração para gaming em 4K com ray tracing avançado', price: 4999.99, originalPrice: 5499.99, rating: 4.8, image: 'https://images.unsplash.com/photo-1555618254-84e2cf498b01?w=400', category: 'Gaming', inStock: true },
    { id: 7, name: 'Processador AMD Ryzen 9 7900X', description: 'CPU de alto desempenho com 12 núcleos e 24 threads para gaming extremo', price: 2899.99, originalPrice: 3299.99, rating: 4.9, image: 'https://images.unsplash.com/photo-1725185574554-df5222013dfd?w=400', category: 'Gaming', inStock: true },
    { id: 8, name: 'Memória RAM DDR5 32GB RGB Gaming', description: 'Kit de memória DDR5 5600MHz com iluminação RGB sincronizável', price: 1299.99, rating: 4.7, image: 'https://images.unsplash.com/photo-1754820978729-39c2e2a15112?w=400', category: 'Gaming', inStock: true },
